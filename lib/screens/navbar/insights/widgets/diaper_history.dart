...
class DiaperHistoryScreen extends StatefulWidget {
  const DiaperHistoryScreen({super.key});

  @override
  State<DiaperHistoryScreen> createState() => _DiaperHistoryScreenState();
}

class _DiaperHistoryScreenState extends State<DiaperHistoryScreen> {
  DateTimeRange? _historyDateRange;
  String _historyFilter = 'All'; // 'All', 'Wet', 'Dirty', 'Mixed'
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      _buildFilterChip('Wet'),
                      const SizedBox(width: 8),
                      _buildFilterChip('Dirty'),
                      const SizedBox(width: 8),
                      _buildFilterChip('Mixed'),
                    ],
                  ),
                ),
              ],
